          ...
          <div className="flex flex-col gap-20 md:gap-28">
            {[
              ...
              },
              {
                ...
                iconColor: "#7c5cff",
                title: "Action lists that show you what to work on this week",
                desc: "Your top priorities at a glance \u2014 overdue invoices to chase, quotes going cold, jobs to schedule, and requests to respond to. Each list is sorted so the most urgent items are on top.",
