    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Mock Line Charts - Matching Real Dashboard */}
          <div style={{ marginBottom: 20 }}>
            <div style={{ fontSize: 13, fontWeight: 700, marginBottom: 12, color: "rgba(234,241,255,0.7)" }}>
              📈 Trends
            </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 12 }}>
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                ...
                <span style={{ padding: "4px 10px", borderRadius: 8, fontSize: 11, fontWeight: 700, background: "rgba(239,68,68,0.16)", color: "#fca5a5" }}>
                  Collections
                </span>
              </div>
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                ...
                <span style={{ padding: "4px 10px", borderRadius: 8, fontSize: 11, fontWeight: 700, background: "rgba(90,166,255,0.16)", color: "#93c5fd" }}>
                  Scheduling
                </span>
              </div>
              <div style={{ fontSize: 12 }}>
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                ...
                <span style={{ padding: "4px 10px", borderRadius: 8, fontSize: 11, fontWeight: 700, background: "rgba(124,92,255,0.16)", color: "#c4b5fd" }}>
                  Sales
                </span>
              </div>
              <div style={{ fontSize: 12 }}>
        ...
        <div style={{ marginBottom: 80 }}>
          ...
          >
            ...
            >
              ...
              <p style={{ fontSize: 14, color: "rgba(234,241,255,0.6)", lineHeight: 1.6 }}>
                See exactly which invoices are 15+ days overdue. One-click to open in Jobber and collect.
              </p>
            </div>
            ...
            >
              ...
              <h3 style={{ fontSize: 18, fontWeight: 700, marginBottom: 8 }}>
                Quote Leak Detection
              </h3>
              <p style={{ fontSize: 14, color: "rgba(234,241,255,0.6)", lineHeight: 1.6 }}>
                Track sent quotes that haven't converted. Follow up before they go cold.
              </p>
            </div>
            ...
            >
              ...
              <p style={{ fontSize: 14, color: "rgba(234,241,255,0.6)", lineHeight: 1.6 }}>
                Find unscheduled jobs that are slipping through the cracks. Stay on top of your backlog.
              </p>
            </div>
            ...
            >
              ...
              <p style={{ fontSize: 14, color: "rgba(234,241,255,0.6)", lineHeight: 1.6 }}>
                No more digging through Jobber reports. See everything that needs attention in one glance.
              </p>
            </div>
            ...
            >
              ...
              <p style={{ fontSize: 14, color: "rgba(234,241,255,0.6)", lineHeight: 1.6 }}>
                Every item links directly to Jobber. Export to CSV for your weekly team meeting.
              </p>
            </div>
            ...
            >
              ...
              <p style={{ fontSize: 14, color: "rgba(234,241,255,0.6)", lineHeight: 1.6 }}>
                Easy on the eyes in the office or out in the field. Your choice.
              </p>
            </div>
          </div>
        </div>
        ...
        <div style={{ marginBottom: 80 }}>
          ...
          >
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <p style={{ fontSize: 14, color: "rgba(234,241,255,0.6)" }}>
                Click the button and authorize with your Jobber account
              </p>
            </div>
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <p style={{ fontSize: 14, color: "rgba(234,241,255,0.6)" }}>
                We pull your invoices, jobs, and quotes automatically
              </p>
            </div>
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <p style={{ fontSize: 14, color: "rgba(234,241,255,0.6)" }}>
                See your dashboard and start collecting, scheduling, and closing
              </p>
            </div>
          </div>
        </div>
        ...
        <div
          style={{
            background: "linear-gradient(135deg, rgba(90,103,216,0.2) 0%, rgba(102,126,234,0.1) 100%)",
            borderRadius: 20,
            padding: "48px 32px",
            textAlign: "center",
        ...
        >
          ...
          <p style={{ fontSize: 16, color: "rgba(234,241,255,0.7)", marginBottom: 24, maxWidth: 500, margin: "0 auto 24px" }}>
        ...
        >
          ...
          <p style={{ marginTop: 8 }}>
            ...
            <a href="/terms" style={{ color: "rgba(234,241,255,0.5)", textDecoration: "none" }}>
              Terms of Service
            </a>
          </p>
        </footer>
